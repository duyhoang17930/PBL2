...
Button::Button(string t,Vector2f size, int charSize,Color bgColor, Color textColor,Vector2f pos,Font *a,Vector2f pos1,bool isAvai){
	text.setString(t);
...
void Button::drawTextTo(RenderWindow &window){
	window.draw(text);
}
